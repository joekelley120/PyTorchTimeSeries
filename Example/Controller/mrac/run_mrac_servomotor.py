...
def main():
    ...
    prediction_horizon_plant = 800
    prediction_horizon_controller = 800
    ...
    if not trained_controller:
        ...
        max_height, min_height = 0.95, -0.95
    ...
    mrac_helper.plot_skyline_response(controller, 20000, 800, 10, 0.95, -0.95, 1.0, 0.02)
